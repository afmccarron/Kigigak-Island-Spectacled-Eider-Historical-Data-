...
XSTUDYAREA = SPACE (4)
XNO_DRAKES = 0
@ 03,10 SAY "WELCOME TO QUACK 2003!"
...
@ 14,37 GET XDate ;
   RANGE CTOD('04/01/2003'),CTOD('09/01/2003')
...
ENDCASE
@ 20,16 GET XNext ;
   RANGE CTOD('00/00/2003'),CTOD('09/01/2003') 
...
CLOSE ALL
use visit
replace all hatch with ctod('01/01/2003') 
set filter to hatch=ctod('01/01/2003') .and. no_eggs>0 .and. status<>'HATCHED'
replace all hatch with date+(26-(val(candle1)+val(candle2))/2)
...
RUN c:\program~1\winzip\winzip32.exe  -F QUACKBAK03
CLEAR
?
? 'INSERT BACKUP DISK IN DRIVE A:'
?
WAIT
RUN COPY QUACKBAK03.ZIP A:
RETURN
PROCEDURE BROOD
	CLEAR
	SET TALK OFF
	...
	*--  Format Page: 1
	...
	@ 15,16 SAY "NEXTVISIT" 
	@ 15,27 GET xnext RANGE CTOD('1/1/2003'),CTOD('8/30/2003')
	READ
...
DO WHILE more
	...
	DO WHILE .NOT. ok
		...
		*--  @GET's
		...
		@ 9,52 GET   RDate RANGE CTOD('4/1/2003'),CTOD('9/1/2003') DEFAULT xdate
...
xserum=0
	...
	*--  Format Page: 1
	...
	REPL trap WITH xtrap,virus WITH xvirus,radio WITH xradio,wholeblood WITH xwholeblood,dna WITH xdna, serum WITH xserum
